        ...
        <main className="max-w-6xl mx-auto px-4 md:px-6 pt-6 md:pt-10 animate-fade-in">
          ...
          {!selectedFolder ? (
            <div className="bg-white p-6 md:p-8 rounded-4xl border border-slate-200/80 shadow-sm space-y-6">
             ...
             <div className="bg-white p-6 md:p-8 rounded-4xl border border-slate-200/80 shadow-sm space-y-6">
              <button onClick={() => setSelectedFolder(null)} className="text-sm font-bold text-slate-500 hover:text-[#1B365D] flex items-center gap-2 mb-4 bg-slate-100 px-4 py-2 rounded-full w-fit">← Back</button>
              ...
              <form onSubmit={handleAddFlashcard} className="flex flex-col gap-4 bg-blue-50 p-4 md:p-6 rounded-2xl border border-blue-100">
                ...
                <button type="submit" className="bg-blue-600 text-white px-8 py-3 rounded-xl font-extrabold text-sm shadow-md mt-2">Save Flashcard</button>
              </form>
